...
@endforelse--}}
@extends('layouts.app') <!--Extender platilla blade-->

@section('content') <!--Invocar seccion content-->
<!--Todo lo que se escriba aqui se verá en el index-->
  ...
  {{--  <td>{{$entrance->id}}</td>
    ...
    <td>
        <form action="{{ route('entrances.destroy', $entrance->id) }}" method="post">
            ...
            <a href="{{ route('entrances.show', $entrance->id) }}"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-eye" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
